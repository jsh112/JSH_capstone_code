...
# === MediaPipe 모듈 ===
from Climb_Mediapipe import PoseTracker, draw_pose_points, classify_occluder, _foot_mask_from_coords
...
# ========= 사용자 환경 경로 =========
MODEL_PATH     = r"C:\Users\PC\Desktop\with_Realsense\best_6.pt"
                    ...
                    for key in current_touched:
                        ...
                        if touch_streak[key] >= TOUCH_THRESHOLD:
                            if route_pos == (total_routes - 1):
                                ...
                                terminal_finished = True        # 이후 프레임도 계속 OFF 유지
...
def main():
    ...
    holds = assign_indices(holds, row_tol=30)
